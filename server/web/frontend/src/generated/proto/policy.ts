...
import type { SessionAccessPolicy } from "./session_access";
...
export interface TamperProcessInfo {
  /** Process ID */
  pid: number;
...
export interface ReportTamperEventRequest {
  /** Client identifier */
  client_id: string;
