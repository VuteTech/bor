...
//
// Icon artwork: "Firefox" from Simple Icons v16.29.0
//   Source:  https://github.com/simple-icons/simple-icons/blob/develop/icons/firefox.svg
//   Licence: CC0 1.0 Universal — see LICENSE.CC0-1.0.md in this directory
//   Trademark: the Firefox mark belongs to the Mozilla Foundation. It is used here only to
...
export const FirefoxMarkIcon = createIcon({
  name: "FirefoxMarkIcon",
  width: 24,
  height: 24,
  svgPath:
...
export default FirefoxMarkIcon;
