...
//
// Icon artwork: "Thunderbird" from Simple Icons v16.29.0
//   Source:  https://github.com/simple-icons/simple-icons/blob/develop/icons/thunderbird.svg
//   Licence: CC0 1.0 Universal — see LICENSE.CC0-1.0.md in this directory
//   Trademark: the Thunderbird mark belongs to MZLA Technologies Corporation / the Mozilla Foundation. It is used here only to
//   identify the product a policy applies to (nominative use); see README.md.
// The createIcon wrapper below is Bor code (LGPL-3.0-or-later).

import { createIcon } from "@patternfly/react-icons/dist/esm/createIcon";

export const ThunderbirdMarkIcon = createIcon({
  name: "ThunderbirdMarkIcon",
  width: 24,
  height: 24,
  svgPath:
...
export default ThunderbirdMarkIcon;
