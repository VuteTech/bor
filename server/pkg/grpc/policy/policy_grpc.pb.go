...
func (c *policyServiceClient) ReportTamperEvent(ctx context.Context, in *ReportTamperEventRequest, opts ...grpc.CallOption) (*ReportTamperEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportTamperEventResponse)
	err := c.cc.Invoke(ctx, PolicyService_ReportTamperEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyServiceClient) ReportSchemaCatalogue(ctx context.Context, in *ReportSchemaCatalogueRequest, opts ...grpc.CallOption) (*ReportSchemaCatalogueResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportSchemaCatalogueResponse)
	err := c.cc.Invoke(ctx, PolicyService_ReportSchemaCatalogue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PolicyService_ReportTamperEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportTamperEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyServiceServer).ReportTamperEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyService_ReportTamperEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServiceServer).ReportTamperEvent(ctx, req.(*ReportTamperEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PolicyService_ReportSchemaCatalogue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportSchemaCatalogueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PolicyServiceServer).ReportSchemaCatalogue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyService_ReportSchemaCatalogue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PolicyServiceServer).ReportSchemaCatalogue(ctx, req.(*ReportSchemaCatalogueRequest))
	}
	return interceptor(ctx, in, info, handler)
}
